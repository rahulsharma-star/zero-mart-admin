  ...
  return (
    <div>
      ...
      <Table
        ...
        dataSource={data ?? []}
        columns={[
          { title: '', dataIndex: 'image_url', width: 64, render: (u: string) => (u ? <Image src={u} width={44} height={44} style={{ borderRadius: 6, objectFit: 'cover' }} /> : null) },
      ...
      <Modal open={open} title={editing ? t('edit') : t('add')} onCancel={() => setOpen(false)} onOk={() => form.submit()} okText={t('save')} confirmLoading={save.isPending}>
        <Form form={form} layout="vertical" onFinish={(v) => save.mutate(v)}>
          ...
          <Form.Item name="image_url" label={t('image_url')}><Input placeholder="https://..." /></Form.Item>
